...
/*
numberOfEntities - число небесных тел внутри галактики
celestialBodyPrefab Ч ссылка на префаб небесного тела
startDistance Ч насколько далеко от центра могут возникать объекты в начале симул€ции (максимальна€ удалЄнность)
startVelocity Ч максимальна€ скорость, которую могут получить объекты в начале симул€ции
startMass Ч максимальна€ начальна€ масса объектов
задачи:
GravitationJob Ч чтобы обрабатывать действие гравитации
MoveJob Ч чтобы двигать объекты.
*/